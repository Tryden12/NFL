package com.tryden.simplenfl.ui.epoxy.controllers.news.home.topheadlines
...
class HomeTopHeadlinesEpoxyController(
    ...
    var newsResponse: com.tryden.simplenfl.network.response.models.news.NewsResponse? = null
        set(value) {
            field = value
            if (value != null) {
                isLoading = false
    ...
    override fun buildModels() {
        ...
        if (headerTopFilled) {
            SectionBottomEpoxyModel(
                useSection = true
            ).id("bottom-home-headlines-1").addTo(this)
        }
    }
